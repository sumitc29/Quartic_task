### Script to generate Xgboost model for realtime data prediction
#Action::This scrript is used to generate and save the XGboost model 
# Inputs:data for model training purpose and evaluation (train file)
#output : Output will be model with the evaluation paramters
